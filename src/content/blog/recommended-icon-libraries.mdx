...
[Lucide](https://lucide.dev) is my base icon library. The React library is easy to use (code sample below), and the icon set is well-designed and consistent. I first learned of it through [shadcn/ui](/shadcnui), and I've been using it since.
