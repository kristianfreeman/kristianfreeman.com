...
While this isn't meant to replace proper error monitoring in production, it's an interesting exploration of how these technologies could be combined. The code is available on [GitHub](https://github.com/kristianfreeman/error-monitor) if you want to experiment with it yourself.
