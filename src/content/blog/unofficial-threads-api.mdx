...
[Threads](https://threads.net) is Facebook's new social media platform similar to Twitter. In this blog post, I’ll show you how to interact with the private API via a Python package called `threads-net` (check it out [here](https://github.com/dmytrostriletskyi/threads-net)).
