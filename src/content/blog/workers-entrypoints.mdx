...
description: A Cloudflare Workers application can have multiple entry points, allowing for different usage patterns.
...
Sure, I work at Cloudflare - but I don't have any particular insight into how entrypoints will evolve on the Workers platform. 
