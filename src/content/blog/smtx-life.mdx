...
I've also build a couple interesting things for the newsletter. Little software tools that I'm using inside of the newsletter to make the content more interesting. For instance, I built a web API that can generate weather forecasts as SVG, which I embed directly in the newsletter:
