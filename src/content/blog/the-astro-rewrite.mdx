...
I've already started implementing a bunch of new features I'm excited about. The ["Tips" page](/tags/tips/) is a great example - it was built on a pretty [hacky implementation](/creating-a-custom-post-list-page-in-bear/) in bearblog, but in Astro, I was able to build a full tag template/page and link to it directly in the nav (`/tags/tip`):
