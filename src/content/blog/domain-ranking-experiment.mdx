...
My DR has climbed a bit, while the backlinks haven't changed much. I'm starting to see some value in writing about [Astro](/tag/astro), particularly since it's been linked on the Astro site, which itself is a DR 84 site.
