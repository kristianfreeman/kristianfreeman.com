...
Another great feature of jsDelivr is the directory UI. By simply going to `/gh/user/repo/` (omitting the `tag` and `file-path`, you can see a complete directory structure for the project, allowing you to click around, and ultimately select a file for inclusion in your project. For an example of this, check out my lilredirector repo [inside of jsDelivr](https://cdn.jsdelivr.net/gh/signalnerve/lilredirector/) — clicking any of the files will give you a versioned and ready-to-use link that you could import into your project.
