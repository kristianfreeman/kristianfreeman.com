...
As I mentioned in my [previous post](/making-the-switch), I switched to Android at the end of last week. I'm still working on a fairly lengthy post about my thoughts on the Android OS, but I thought I'd post quickly about a tool I'm really enjoying called [Tasker](http://tasker.dinglisch.net/).
