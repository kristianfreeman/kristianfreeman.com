...
This will output all lines that _don't_ match either "DEBUG" or "ERROR". This is a great way to filter out noisy log lines. You can also use `grep` to filter out lines that don't match a pattern, like this:
