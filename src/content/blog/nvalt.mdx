...
Enter [nvALT](brettterpstra.com/projects/nvalt/). nvALT is a fork of [Notational Velocity](http://notational.net/), a pretty killer note-taking app. The motivations of the app are explained on NV's site:
