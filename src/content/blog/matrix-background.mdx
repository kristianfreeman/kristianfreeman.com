...
I build a neat Matrix-style background for a recent project. I don't think I'm going to launch the project, so I wanted to share the background code, because it looks quite cool!
