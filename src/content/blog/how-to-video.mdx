...
> Quick note: This post is a draft. It might feel a little sparse as I fill in various details. If you have any questions, [reach out to me on 𝕏](https://twitter.com/kristianf_).
...
This setup is pretty legit. Like... it's expensive. It took me about four years to get all of this together. And it looks great! The FX30 can act as a webcam over USB-C, so in addition to being an incredible camera, it looks unreal in meetings.
...
1. Low-pass filter (1-2kHz) to remove any desk thumping, low-end noise, etc.
